    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (session && dashboardUrl.includes('localhost')) {
                ...
                window.location.href = `${dashboardUrl}#access_token=${session.access_token}&refresh_token=${session.refresh_token}&type=recovery`;
            } else {
                        ...
                        <form onSubmit={handleLogin} className="space-y-5">
                            ...
                            <div>
                                <div className="flex items-center justify-between mb-2 ml-1">
                                    ...
                                    <Link to="/forgot-password" title="sm" className="text-xs font-bold text-[#0ea5e9] hover:underline">
                                        Forgot?
                                    </Link>
                                </div>
                                <div className="relative group">
